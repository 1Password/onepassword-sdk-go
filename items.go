...
type ItemsAPI interface {
	...
	// List all items
	List(ctx context.Context, vaultId string) (*Iterator[ItemOverview], error)
}
...
// List all items
func (s ItemsSource) List(ctx context.Context, vaultId string) (*Iterator[ItemOverview], error) {
	resultString, err := clientInvoke(ctx, s.InnerClient, "ItemsList", map[string]interface{}{
		"vault_id": vaultId,
	})
	if err != nil {
		return nil, err

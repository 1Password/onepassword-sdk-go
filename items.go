...
func (i ItemsSource) Create(ctx context.Context, params ItemCreateParams) (Item, error) {
	resultString, err := clientInvoke(ctx, i.InnerClient, "ItemsCreate", map[string]any{
		"params": params,
	})
	if err != nil {
		return Item{}, err
...
func (i ItemsSource) CreateAll(ctx context.Context, vaultID string, params []ItemCreateParams) (ItemsUpdateAllResponse, error) {
	resultString, err := clientInvoke(ctx, i.InnerClient, "ItemsCreateAll", map[string]any{
		"vault_id": vaultID,
		"params":   params,
	})
	if err != nil {
...
func (i ItemsSource) Get(ctx context.Context, vaultID string, itemID string) (Item, error) {
	resultString, err := clientInvoke(ctx, i.InnerClient, "ItemsGet", map[string]any{
		"vault_id": vaultID,
		"item_id":  itemID,
	})
	if err != nil {
...
func (i ItemsSource) GetAll(ctx context.Context, vaultID string, itemIds []string) (ItemsGetAllResponse, error) {
	resultString, err := clientInvoke(ctx, i.InnerClient, "ItemsGetAll", map[string]any{
		"vault_id": vaultID,
		"item_ids": itemIds,
	})
	if err != nil {
...
func (i ItemsSource) Put(ctx context.Context, item Item) (Item, error) {
	resultString, err := clientInvoke(ctx, i.InnerClient, "ItemsPut", map[string]any{
		"item": item,
	})
	if err != nil {
		return Item{}, err
...
func (i ItemsSource) Delete(ctx context.Context, vaultID string, itemID string) error {
	_, err := clientInvoke(ctx, i.InnerClient, "ItemsDelete", map[string]any{
		"vault_id": vaultID,
		"item_id":  itemID,
	})
	return err
...
func (i ItemsSource) DeleteAll(ctx context.Context, vaultID string, itemIds []string) (ItemsDeleteAllResponse, error) {
	resultString, err := clientInvoke(ctx, i.InnerClient, "ItemsDeleteAll", map[string]any{
		"vault_id": vaultID,
		"item_ids": itemIds,
	})
	if err != nil {
...
func (i ItemsSource) Archive(ctx context.Context, vaultID string, itemID string) error {
	_, err := clientInvoke(ctx, i.InnerClient, "ItemsArchive", map[string]any{
		"vault_id": vaultID,
		"item_id":  itemID,
	})
	return err
...
func (i ItemsSource) List(ctx context.Context, vaultID string, filters ...ItemListFilter) ([]ItemOverview, error) {
	...
	resultString, err := clientInvoke(ctx, i.InnerClient, "ItemsList", map[string]any{
		"vault_id": vaultID,
		"filters":  filters,
	})
	if err != nil {

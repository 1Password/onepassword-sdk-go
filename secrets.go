...
type SecretsAPI interface {
	...
	// Secret references are url-like strings that link to secret fields in 1Password. They have the following format: op://<vault-name>/<item-name>[/<section-name>]/<field-name>

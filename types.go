...
type ItemsGetAllError string

const (
	ItemsGetAllErrorItemNotFound ItemsGetAllError = "itemNotFound"
)

type ItemsGetAllResponse struct {
	IndividualResponses []Response[Item, ItemsGetAllError] `json:"individualResponses"`
}
type ItemUpdateFailureReason string

const (
	// Item update operation failed due to inactive session.
	ItemUpdateFailureReasonItemStatusExpired ItemUpdateFailureReason = "itemStatusExpired"
	// Item update operation failed due to a bad request value.
	ItemUpdateFailureReasonItemStatusValidationError ItemUpdateFailureReason = "itemStatusValidationError"
	...
	ItemUpdateFailureReasonItemStatusPermissionError ItemUpdateFailureReason = "itemStatusPermissionError"
	// Item update operation experienced an internal server error.
	ItemUpdateFailureReasonItemStatusServerError ItemUpdateFailureReason = "itemStatusServerError"
	// Item update operation failed due to incorrect version.
	ItemUpdateFailureReasonItemStatusIncorrectItemVersion ItemUpdateFailureReason = "itemStatusIncorrectItemVersion"
	// Item update operation failed because a file reference didn't match a known file.
	ItemUpdateFailureReasonItemStatusFileNotFound ItemUpdateFailureReason = "itemStatusFileNotFound"
	// Item update request is too big to be sent to the server.
	ItemUpdateFailureReasonItemStatusTooBig ItemUpdateFailureReason = "itemStatusTooBig"
	// Not yet supported reason.
	ItemUpdateFailureReasonUnknown ItemUpdateFailureReason = "unknown"
)
